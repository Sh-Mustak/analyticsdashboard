export default function Header() {
  return (
    <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 z-10">
      {/* <!-- Mobile menu button --> */}
      <button
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="hidden sm:block h-8 w-[1px] bg-slate-200 dark:bg-slate-800 mx-2"></div>
