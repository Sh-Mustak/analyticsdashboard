...
export default function Sidebar({isSidebarOpen, setIsSidebarOpen }: { isSidebarOpen: boolean, setIsSidebarOpen: (isSidebarOpen: boolean) => void }) {
  const handleSidebarToggle = () => {
    setIsSidebarOpen(!isSidebarOpen); // Toggle the sidebar open/closed state
  }
  ...
  return (
    <aside
      ...
      flex flex-col z-40 lg:z-20 transition-transform duration-300
    ...
    >
      ...
      <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
        <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800">
